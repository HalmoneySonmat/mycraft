...
@OnlyIn(Dist.CLIENT)
public class ExampleNotificationModUpdateScreen extends Screen
{
    ...
    public ExampleNotificationModUpdateScreen(Button modButton)
    {
    ...
    public static net.minecraftforge.client.gui.NotificationModUpdateScreen init(ExampleTitleScreen guiMainMenu, Button modButton)
    {
        net.minecraftforge.client.gui.NotificationModUpdateScreen notificationModUpdateScreen = new net.minecraftforge.client.gui.NotificationModUpdateScreen(modButton);
