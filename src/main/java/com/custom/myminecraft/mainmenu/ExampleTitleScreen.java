package com.custom.myminecraft.mainmenu;
...
@OnlyIn(Dist.CLIENT)
public class ExampleTitleScreen extends Screen {
    
    private static final Logger LOGGER = LogUtils.getLogger();
    private static final String DEMO_LEVEL_ID = "Demo_World";
    public static final Component COPYRIGHT_TEXT = new TextComponent("");
    public static final CubeMap CUBE_MAP = new CubeMap(MainScreenEditor.customPanoramaFolder());
    private static final ResourceLocation PANORAMA_OVERLAY = new ResourceLocation("textures/gui/title/background/panorama_overlay.png");
    private static final ResourceLocation ACCESSIBILITY_TEXTURE = MainScreenEditor.customAccessibilityButtonImage();
    private final boolean minceraftEasterEgg;
    @Nullable
    private String splash;
    private Button resetDemoButton;
    private static final ResourceLocation MINECRAFT_LOGO = MainScreenEditor.customMinecraftLogo();
    private static final ResourceLocation MINECRAFT_EDITION = MainScreenEditor.customMinecraftEditionLogo();
    ...
    public ExampleTitleScreen(boolean p_96733_) {
    ...
    private TitleScreen defaultTitleScreen;
    public void setTitleScreen(TitleScreen titleScreen){
        this.defaultTitleScreen = titleScreen;
    }
    ...
    protected void init() {
        ...
        if (this.minecraft.isDemo()) {
            ...
            modButton = this.addRenderableWidget(MainScreenEditor.customButton(new ModsButton(this.width / 2 - 100, l + 24 * 2, 98, 20, new TranslatableComponent("fml.menu.mods"), button -> {
                this.minecraft.setScreen(new net.minecraftforge.client.gui.ModListScreen(this));
            })));
        }

        //TODO new TitleScreen()
        modUpdateNotification = ExampleNotificationModUpdateScreen.init(this, modButton);
//3qjsWoRjdla
        this.addRenderableWidget(MainScreenEditor.customButton(new LanguageButton(this.width / 2 - 124, l + 72 + 12, 20, 20, 0, 106, 20, Button.WIDGETS_LOCATION, 256, 256, (p_96791_) -> {
            this.minecraft.setScreen(new LanguageSelectScreen(this, this.minecraft.options, this.minecraft.getLanguageManager()));
        }, new TranslatableComponent("narrator.button.language"))));
        this.addRenderableWidget(MainScreenEditor.customButton(new OptionsButton(this.width / 2 - 100, l + 72 + 12, 98, 20, new TranslatableComponent("menu.options"), (p_96788_) -> {
            this.minecraft.setScreen(new OptionsScreen(this, this.minecraft.options));
        })));
        this.addRenderableWidget(MainScreenEditor.customButton(new QuitButton(this.width / 2 + 2, l + 72 + 12, 98, 20, new TranslatableComponent("menu.quit"), (p_96786_) -> {
            this.minecraft.stop();
        })));
        this.addRenderableWidget(MainScreenEditor.customButton(new AccessibilitySettingsButton(this.width / 2 + 104, l + 72 + 12, 20, 20, 0, 0, 20, ACCESSIBILITY_TEXTURE, 32, 64, (p_96784_) -> {
        ...
        if (!this.minecraft.is64Bit()) {
            ...
            this.warning32Bit = new Warning32Bit(MultiLineLabel.create(this.font, new TranslatableComponent("title.32bit.deprecation"), 350, 2), this.width / 2, l - 24, completablefuture);
        }
    ...
    private void createNormalMenuOptions(int p_96764_, int p_96765_) {
        this.addRenderableWidget(
                MainScreenEditor.customButton(new SinglePlayButton(
                        this.width / 2 - 100, //첫 번째 - 버튼 좌,우 위치
                        p_96764_, //두 번째 - 버튼 상,하 위치
                        200, //세 번째 버튼 좌,우 크기
                        20, //네 번째 - 버튼 상,하크기
                        new TranslatableComponent("menu.singleplayer.example"), //다섯 번째 - 버튼이름
                        (p_96776_) -> {
        ...
        Button.OnTooltip button$ontooltip = flag ? Button.NO_TOOLTIP : new Button.OnTooltip() {
            ...
            public void onTooltip(Button p_169458_, PoseStack p_169459_, int p_169460_, int p_169461_) {
                if (!p_169458_.active) {
                    ExampleTitleScreen.this.renderTooltip(p_169459_, ExampleTitleScreen.this.minecraft.font.split(this.text, Math.max(ExampleTitleScreen.this.width / 2 - 43, 170)), p_169460_, p_169461_);
                }
        ...
        (this.addRenderableWidget(MainScreenEditor.customButton(new MultiPlayButton(this.width / 2 - 100, p_96764_ + p_96765_ * 1, 200, 20, new TranslatableComponent("menu.multiplayer"), (p_210872_) -> {
            Screen screen = (Screen)(this.minecraft.options.skipMultiplayerWarning ? new JoinMultiplayerScreen(this) : new SafetyScreen(this));
            this.minecraft.setScreen(screen);
        }, button$ontooltip)))).active = flag;
        (this.addRenderableWidget(MainScreenEditor.customButton(new RealmsButton(this.width / 2 + 2, p_96764_ + p_96765_ * 2, 98, 20, new TranslatableComponent("menu.online"), (p_96771_) -> {
    ...
    public void render(PoseStack p_96739_, int p_96740_, int p_96741_, float p_96742_) {
        ...
        if ((l & -67108864) != 0) {
            ...
            //TODO new TitleScreen()
            net.minecraftforge.client.ForgeHooksClient.renderMainMenu(new TitleScreen(false), p_96739_, this.font, this.width, this.height, l);
            if (this.splash != null) {
                p_96739_.pushPose();
            ...
            net.minecraftforge.internal.BrandingControl.forEachLine(true, true, (brdline, brd) ->
                    ...
                    drawString(p_96739_, this.font,
                            "", //new String(brd + "haha"),
                            2, this.height - ( 10 + brdline * (this.font.lineHeight + 1)), 16777215 | l)
            );

            net.minecraftforge.internal.BrandingControl.forEachAboveCopyrightLine((brdline, brd) ->
                    drawString(p_96739_, this.font,
                            "", //brd + "haha",
                            this.width - font.width(""), //font.width(brd + "haha"),
            ...
            //TODO super -> this.defaultTitleScreen
