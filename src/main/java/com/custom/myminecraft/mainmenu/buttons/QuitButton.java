...
public class QuitButton extends CustomButton {
    ...
    public QuitButton(int leftAndRightPosition, int upAndDownPosition, int width, int height, Component buttonName, OnPress clickEvent){
    ...
    public QuitButton(int leftAndRightPosition, int upAndDownPosition, int width, int height, Component buttonName, OnPress clickEvent, String message){
        super(leftAndRightPosition, upAndDownPosition, width, height, buttonName, clickEvent);
        System.out.println(message);
    }

    public QuitButton getRealButton(){
        return new QuitButton(this.leftAndRightPosition, this.upAndDownPosition, this.width, this.height, this.buttonName, this.clickEvent, "Setting QuitButton");
    }
