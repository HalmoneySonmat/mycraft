...
public class SinglePlayButton extends CustomButton {
    ...
    public SinglePlayButton(int leftAndRightPosition, int upAndDownPosition, int width, int height, Component buttonName, OnPress clickEvent){
    ...
    public SinglePlayButton(int leftAndRightPosition, int upAndDownPosition, int width, int height, Component buttonName, OnPress clickEvent, String message){
        super(leftAndRightPosition, upAndDownPosition, width, height, buttonName, clickEvent);
        System.out.println(message);
    }

    public SinglePlayButton getRealButton(){
        return new SinglePlayButton(this.leftAndRightPosition, this.upAndDownPosition, this.width, this.height, this.buttonName, this.clickEvent, "Setting SinglePlayButton");
    }
