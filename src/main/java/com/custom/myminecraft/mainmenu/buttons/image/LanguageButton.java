...
public class LanguageButton extends CustomImageButton {
    ...
    public LanguageButton(int leftAndRightPosition, int upAndDownPosition, int width, int height,
    ...
    public LanguageButton getRealButton(){
        return new LanguageButton(this.leftAndRightPosition, this.upAndDownPosition, this.width, this.height,
