...
public class RealmsButton extends CustomButton {
    ...
    public RealmsButton(int leftAndRightPosition, int upAndDownPosition, int width, int height, Component buttonName, OnPress clickEvent, OnTooltip onTooltip){
    ...
    public RealmsButton(int leftAndRightPosition, int upAndDownPosition, int width, int height, Component buttonName, OnPress clickEvent, OnTooltip onTooltip, String message){
        super(leftAndRightPosition, upAndDownPosition, width, height, buttonName, clickEvent, onTooltip);
        System.out.println(message);
    }

    public RealmsButton getRealButton(){
        return new RealmsButton(this.leftAndRightPosition, this.upAndDownPosition, this.width, this.height, this.buttonName, this.clickEvent, this.onTooltip, "Setting RealmsButton");
    }
